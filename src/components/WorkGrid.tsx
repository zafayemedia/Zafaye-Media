...
// A plain ROAS multiplier ("8.4x", "7x") is the headline number type, so it
// gets the same larger size as the featured metric rather than the smaller
// size everything else (PKR ranges, phrases) uses.
